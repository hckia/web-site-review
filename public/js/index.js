...
function sendSignUpData(firstName, lastName, userName, password){
  ...
  axios({
    ...
    .catch(err => {
      console.log(JSON.stringify(err.response.data.location));
      let locOfErr = JSON.stringify(err.response["data"]["location"]);
      let targetDialog;
      let targetFocus;
      //maybe we can use match to check for the 422 generated by this error to be more specific?
...
/*
        <div id="dialog-invalid-firstname" title="Invalid first name">Your first name must contain a character</div>
        <div id="dialog-invalid-lastname" title="Invalid last name">Your last name must contain a character</div>
        <div id="dialog-invalid-username" title="Invalid username">Your  username must contain a character</div>
        <div id="dialog-invalid-password"
*/
      $(targetDialog).dialog({
         autoOpen: false, 
         hide: "puff",
         ...
         modal: true,
         buttons: {
            OK: function() {$(this).dialog("close"); $(targetFocus).focus();}
         },
      });
...
function hideDialogs(){
  ...
  $("dialog-about").hide();
  $("#dialog-validation-err-firstname").hide();
  $("#dialog-validation-err-lastname").hide();
  $("#dialog-validation-err-username").hide();
  $("#dialog-validation-err-password").hide();
  $("#dialog-invalid-firstname").hide();
  $("#dialog-invalid-lastname").hide();
  $("#dialog-invalid-username").hide();
  $("#dialog-username-taken").hide();
  $("#dialog-invalid-password").hide();
}
