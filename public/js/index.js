...
function demoLogin(){
  console.log('demo login active');
  $("#js-demo").click(function(event){
    event.preventDefault();
    console.log('demo login activated');
    sendLoginData('jiggywitit123', 'TyteuvwutDyredHa');
  })
}
...
function hideDialogs(){
  ...
  $("#dialog-404-bad").hide();
  $("#dialog-add-site-taken").hide();
  $("#dialog-add-site-fail").hide();
  $("#dialog-add-description-fail").hide();
  $("#dialog-login").hide();
